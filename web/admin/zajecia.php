...
<td>					<span class="ikonka icon-date">termin: </span><span class="ile-terminow">  <strong>'.$result['LiczbaTerminow'].'</strong></span> <a href="?p=zapisy&id='.$result['IdZajecia'].'" title="Zapisy na ten termin"><span class="ikonka icon-group">studentów zapisanych: </span><span class="ile-terminow">  <strong>'.$result['ZapisanychStudentow'].'</strong></a>';
					
					if(!isset($result['Imie'])) echo '';
					else echo '<a href="?p=prowadzacy_edycja&id='.$result['IdProwadzacy'].'" title="Edycja prowadzącego"><span class="ikonka icon-user_gray">prowadzący: </span><span class="ile-terminow">'.$result['Tytul'].' '.$result['Imie'][0].'. '.$result['Nazwisko'];
					echo '</a></td>
